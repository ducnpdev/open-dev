...
def lambda_handler(event, context):
    ...
    lower_list = dict((k.upper(), v) for k, v in event['headers'].items())
    apiKey = lower_list['X-IBM-CLIENT-SECRET']
    ...
    policy.allowMethod('POST', '/*') 
    policy.allowMethod('OPTIONS', '/*') 
    policy.allowMethod('PUT', '/*') 
    policy.allowMethod('GET', '/*') 
    policy.allowMethod('PATCH', '/*') 
    policy.allowMethod('HEAD', '/*') 
    policy.allowMethod('DELETE', '/*') 
    policy.allowMethod('*', '/*') 
