...
func BaseAddRoute(app *gin.Engine) {
	...
	app.POST(BusiAPI+"/TransIn1", dtmutil.WrapHandler(func(c *gin.Context) interface{} {
		return handleGeneralBusiness(c, MainSwitch.TransInResult.Fetch(), reqFrom(c).TransInResult, "transIn")
	}))
	app.POST(BusiAPI+"/TransIn2", dtmutil.WrapHandler(func(c *gin.Context) interface{} {
	...
	app.POST(BusiAPI+"/TransOut1", dtmutil.WrapHandler(func(c *gin.Context) interface{} {
		return handleGeneralBusiness(c, MainSwitch.TransOutResult.Fetch(), reqFrom(c).TransOutResult, "TransOut")
	}))
	app.POST(BusiAPI+"/TransOut2", dtmutil.WrapHandler(func(c *gin.Context) interface{} {
		return handleGeneralBusiness(c, MainSwitch.TransOutResult.Fetch(), reqFrom(c).TransOutResult, "TransOut")
	}))
